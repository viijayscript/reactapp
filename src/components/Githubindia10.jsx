    ...
    return(
            <div style={{padding: 20,width: "100%"}}>
                {!completed ? (
                    ...
                    <br/>
                    <ResponsiveEmbed src='https://www.viijayscript.com/2022/07/list-of-github-open-source-projects-built-in-or-receiving-significant-contributions-from-india-part-10.html?m=1' allowFullScreen ratio='9:16'/>
                    </div>
                )
                }
